...
public class rini extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Gudeg Bu Hj Rini");
        tel.setText("+62 815-7894-7181");
        map.setText(R.string.rini_alamat);
        deskripsi.setText(R.string.rini_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 815-7894-7181";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.804662+","+ 110.366750));
