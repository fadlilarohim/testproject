...
public class SentraGudeg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Sentra Gudeg Wijilan");
        tel.setText("-");
        map.setText(R.string.sentra_alamat);
        deskripsi.setText(R.string.sentra_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("geo:-7.8048186,110.3669047?z=18&q=gudeg");
