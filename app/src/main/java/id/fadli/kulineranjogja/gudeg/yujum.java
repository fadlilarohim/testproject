...
public class yujum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Gudeg Yu Djum Wijilan");
        ...
        title.setText("Gudeg Yu Djum Wijilan");
        tel.setText("+62 274 7860204");
        map.setText(R.string.yujum_alamat);
        deskripsi.setText(R.string.yujum_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 274 7860204";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.804579+","+ 110.366779));
