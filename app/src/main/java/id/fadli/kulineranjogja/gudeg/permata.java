package id.fadli.kulineranjogja.gudeg;
...
public class permata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Gudeg Permata Bu Pujo");
        ...
        title.setText("Gudeg Permata Bu Pujo");
        tel.setText("+62 274 553853");
        map.setText(R.string.permata_alamat);
        deskripsi.setText(R.string.permata_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 274 553853";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.801482+","+ 110.373166));
