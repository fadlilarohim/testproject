...
public class tekluk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Gudeg Bromo Bu Tekluk");
        ...
        title.setText("Gudeg Bromo Bu Tekluk");
        tel.setText("-");
        map.setText(R.string.tekluk_alamat);
        deskripsi.setText(R.string.tekluk_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.825718+","+ 110.367472));
