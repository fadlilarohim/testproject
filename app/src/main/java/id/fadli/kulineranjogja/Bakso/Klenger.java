...
public class Klenger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bakso Klenger Ratu Sari");
        ...
        title.setText("Bakso Klenger Ratu Saria");
        tel.setText("+62 812-4621-1014");
        map.setText(R.string.Klenger_alamat);
        deskripsi.setText(R.string.Klenger_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 812-4621-1014";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+-7.779247+","+110.399970));
