...
public class Tengkleng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bakso Tengkleng Mas Bambang Jogja");
        ...
        title.setText("Bakso Tengkleng Mas Bambang Jogja");
        tel.setText("+62 813-6011-1888");
        map.setText(R.string.Bambang_alamat);
        deskripsi.setText(R.string.Bambang_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+6281360111888";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.760498 + "," + 110.369260));
