...
public class JawiMiyar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Bakso Jawi Miyar");
        tel.setText("+62274418620");
        map.setText(R.string.Jawi_alamat);
        deskripsi.setText(R.string.Jawi_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62274418620";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+-7.793749+","+110.361120));
