...
public class Ironayan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Bakso Ironayan");
        tel.setText("+62 857-2947-7577");
        map.setText(R.string.Ironayan_alamat);
        deskripsi.setText(R.string.Ironayan_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.830329 + "," + 110.418782));
