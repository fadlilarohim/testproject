...
public class Karno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bakso Malang Cak Karno ");
        ...
        title.setText("Bakso Malang Cak Karno");
        tel.setText("+62 878-3970-0485");
        map.setText(R.string.Karno_alamat);
        deskripsi.setText(R.string.Karno_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 878-3970-0485";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.813350 + "," + 110.358893));
