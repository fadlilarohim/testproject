...
public class Blangkon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Bakso Mr.Blangkon");
        tel.setText("+62 852-9280-0556");
        map.setText(R.string.Blangkon_alamat);
        deskripsi.setText(R.string.Blangkon_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 852-9280-0556";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.680328 + "," + 110.418193));
