...
public class Telkom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Bakso Telkom Utomo");
        tel.setText("+62274583692");
        map.setText(R.string.Telkom_alamat);
        deskripsi.setText(R.string.Telkom_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.799579 + "," + 110.392656));
