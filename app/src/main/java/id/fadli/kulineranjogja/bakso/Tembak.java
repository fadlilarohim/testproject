...
public class Tembak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bakso Lapangan Tembak");
        ...
        title.setText("Bakso Lapangan Tembak");
        tel.setText("+62 274 4431348");
        map.setText(R.string.Tembak_alamat);
        deskripsi.setText(R.string.Tembak_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 857-2947-7577";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.782784 + "," + 110.401604));
