...
public class sekarsuli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Mie Ayam Sekarsuli");
        tel.setText("-");
        map.setText(R.string.sekarsuli_alamat);
        deskripsi.setText(R.string.sekarsuli_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.822933+","+ 110.425236));
