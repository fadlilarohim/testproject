...
public class ijo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Mie Ayam Ijo Tunggal Rasa");
        ...
        title.setText("Mie Ayam Ijo Tunggal Rasa");
        tel.setText("+62 877-3969-0625");
        map.setText(R.string.ijo_alamat);
        deskripsi.setText(R.string.ijo_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 877-3969-0625";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.779538 + "," + 110.379197));
