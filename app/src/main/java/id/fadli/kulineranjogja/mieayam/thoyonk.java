...
public class thoyonk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Mie Ayam Pak Thoyonk");
        tel.setText("+62 856-4300-0358");
        map.setText(R.string.thoyonk_alamat);
        deskripsi.setText(R.string.thoyonk_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 856-4300-0358";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.779383 + "," + 110.379681));
