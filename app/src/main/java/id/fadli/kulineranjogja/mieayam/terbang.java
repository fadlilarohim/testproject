...
public class terbang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Mie Ayam Terbang");
        tel.setText("+62 812-1309-8094");
        map.setText(R.string.terbang_alamat);
        deskripsi.setText(R.string.terbang_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 812-1309-8094";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.798708 + "," + 110.412042));
