...
public class afui extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Mie Ayam Palembang AFUI");
        ...
        title.setText("Mie Ayam Palembang AFUI");
        tel.setText("+62 857-9633-6132");
        map.setText(R.string.afui_alamat);
        deskripsi.setText(R.string.afui_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 857-9633-6132";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.780052 + "," + 110.416416));
