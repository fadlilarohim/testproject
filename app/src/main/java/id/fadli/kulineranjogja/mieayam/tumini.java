...
public class tumini extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Mie Ayam Bu TUMINI Sarirasa Jatiayu");
        ...
        title.setText("Mie Ayam Bu TUMINI Sarirasa Jatiayu");
        tel.setText("+62274410334");
        map.setText(R.string.tumini_alamat);
        deskripsi.setText(R.string.tumini_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62274410334";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.833794+","+ 110.390703));
