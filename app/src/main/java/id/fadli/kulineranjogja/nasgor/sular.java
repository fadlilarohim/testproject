...
public class sular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Nasi Goreng Sapi Dan Kambing Pak Sular");
        ...
        title.setText("Nasi Goreng Sapi Dan Kambing Pak Sular");
        tel.setText("-");
        map.setText(R.string.sular_alamat);
        deskripsi.setText(R.string.sular_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.788381+","+ 110.377159));
