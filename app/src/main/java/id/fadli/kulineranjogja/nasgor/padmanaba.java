...
public class padmanaba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Nasi Goreng Padmanaba");
        ...
        title.setText("Nasi Goreng Padmanaba");
        tel.setText("-");
        map.setText(R.string.padmanaba_alamat);
        deskripsi.setText(R.string.padmanaba_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.786820+","+ 110.373278));
