...
public class beringharjo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Nasi Goreng Beringharjo");
        ...
        title.setText("Nasi Goreng Beringharjo");
        tel.setText("-");
        map.setText(R.string.beringharjo_alamat);
        deskripsi.setText(R.string.beringharjo_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.800717+","+ 110.368974));
