...
public class beni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Nasi Goreng Pak Beni");
        tel.setText("-");
        map.setText(R.string.beni_alamat);
        deskripsi.setText(R.string.beni_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.781788+","+ 110.387978));
