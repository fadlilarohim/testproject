...
public class maswit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Nasi Goreng Mas Wit");
        tel.setText("-");
        map.setText(R.string.maswit_alamat);
        deskripsi.setText(R.string.maswit_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.769895+","+ 110.389003));
