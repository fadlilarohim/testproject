...
public class nasgorpele extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Nasi Goreng Pak Pele");
        tel.setText("-");
        map.setText(R.string.Pele_alamat);
        deskripsi.setText(R.string.nasgorpele_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.805379+","+ 110.365253));
