...
public class ita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Nasi Goreng Bu Ita");
        tel.setText("-");
        map.setText(R.string.ita_alamat);
        deskripsi.setText(R.string.ita_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.755936+","+ 110.376718));
