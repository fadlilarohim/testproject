...
public class hadi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bakmi Jawa Mbah Hadi Terban");
        ...
        title.setText("Bakmi Jawa Mbah Hadi Terban");
        tel.setText("+62 812-2721-670");
        map.setText(R.string.Hadi_alamat);
        deskripsi.setText(R.string.Hadi_deskripsi);
