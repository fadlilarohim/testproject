...
public class dumuk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Bakmi Mbah Dumuk");
        tel.setText("+62 858-6856-6928");
        map.setText(R.string.dumuk_alamat);
        deskripsi.setText(R.string.dumuk_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 858-6856-6928";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.700766 + "," + 110.348677));
