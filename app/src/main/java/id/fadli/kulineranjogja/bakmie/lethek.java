package id.fadli.kulineranjogja.bakmie;
...
public class lethek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Mie Lethek Bantul Mbah Mendes");
        ...
        title.setText("Mie Lethek Bantul Mbah Mendes");
        tel.setText("+62 851-0094-0338");
        map.setText(R.string.lethek_alamat);
        deskripsi.setText(R.string.lethek_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 851-0094-0338";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.765915 + "," + 110.432791));
