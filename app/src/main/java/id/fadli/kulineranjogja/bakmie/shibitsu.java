...
public class shibitsu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Bakmi Shibitsu");
        tel.setText("-");
        map.setText(R.string.shibitsu_alamat);
        deskripsi.setText(R.string.shibitsu_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.821733 + "," + 110.355325));
