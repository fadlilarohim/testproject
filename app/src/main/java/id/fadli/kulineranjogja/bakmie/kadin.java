...
public class kadin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bakmi & Bajigur Kadin Mbah Hj. Karto");
        ...
        title.setText("Bakmi & Bajigur Kadin Mbah Hj. Karto");
        tel.setText("+62 274 373396");
        map.setText(R.string.kadin_alamat);
        deskripsi.setText(R.string.kadin_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 274 373396";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.801942 + "," + 110.372563));
