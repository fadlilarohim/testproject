...
public class dongeng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Dongeng Kopi Jogja");
        tel.setText("+62 877-1999-9267");
        map.setText(R.string.dongeng_alamat);
        deskripsi.setText(R.string.dongeng_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 877-1999-9267";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.759864+","+ 110.403792));
