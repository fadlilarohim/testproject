...
public class blandongan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Warung Kopi Blandongan");
        ...
        title.setText("Warung Kopi Blandongan");
        tel.setText("+62 274 7800325");
        map.setText(R.string.blandongan_alamat);
        deskripsi.setText(R.string.blandongan_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 274 7800325";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.788875+","+ 110.398245));
