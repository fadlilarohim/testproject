...
public class omah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Omah Kopi");
        tel.setText("-");
        map.setText(R.string.omah_alamat);
        deskripsi.setText(R.string.omah_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.793530+","+ 110.385856));
