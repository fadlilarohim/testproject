...
public class mato extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Mato Kopi Jogja");
        tel.setText("-");
        map.setText(R.string.mato_alamat);
        deskripsi.setText(R.string.mato_deskripsi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.767829+","+ 110.399103));
