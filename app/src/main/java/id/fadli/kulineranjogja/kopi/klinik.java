...
public class klinik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Klinik Kopi");
        tel.setText("+62 813-9278-4240");
        map.setText(R.string.klinik_alamat);
        deskripsi.setText(R.string.klinik_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 813-9278-4240";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.737904+","+ 110.394436 ));
