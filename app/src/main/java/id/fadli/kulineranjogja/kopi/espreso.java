...
public class espreso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Kedai Kopi Espresso Bar");
        ...
        title.setText("Kedai Kopi Espresso Bar");
        tel.setText("+62 274 880008");
        map.setText(R.string.espreso_alamat);
        deskripsi.setText(R.string.espreso_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 274 880008";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr="+ -7.748607+","+ 110.387007));
