...
public class raminten extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("House Of Raminten");
        tel.setText("+62 274 547315");
        map.setText(R.string.raminten_alamat);
        deskripsi.setText(R.string.raminten_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 274 547315";
