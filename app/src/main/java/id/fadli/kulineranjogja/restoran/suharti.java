...
public class suharti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Ayam Goreng Suharti Adisucipto");
        ...
        title.setText("Ayam Goreng Suharti Adisucipto");
        tel.setText("+62 274 484522");
        map.setText(R.string.suharti_alamat);
        deskripsi.setText(R.string.suharti_deskripsi);

        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String number = "+62 274 484522";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr=&daddr=" + -7.783119 + "," + 110.413469));
